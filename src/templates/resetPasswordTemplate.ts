...
<body
  ...
  <div style="display: none;">A request to reset password was received from your toystore-be Account</div>
  <div role="article" aria-roledescription="email" aria-label="Reset your Password" lang="en">
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="margin: 0 0 24px;">
                        This is the password reset OTP you requested from toystore-be. Use to reset your toystore-be account password.
                      </p>
                      ...
                      <p style="margin: 0 0 16px;">
                        ...
                        <a href="mailto:kdilipsms@gmail.com" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0; text-decoration: none;">kdilipsms@gmail.com</a>.
                      </p>
                    </td>
                  </tr>
                  <tr>
    ...
    const text = `
        Reset Password, You recently requested to reset your password for your toystore-be account. Copy and paste it for reset password:
        ${otp}
